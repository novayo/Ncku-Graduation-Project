...
if __name__ == '__main__':
    ...
    while True:
        ...
        if ((IDS_New != MTU_IDS) and (IDS_Old != MTU_IDS)): #if rtu ide new and old mismatch MTU ide
            RTU_Client.send(sendstr("Mismatch IDS!"))
            RTU_Client.recv(1024).decode('ascii') ##### Receive MTU IDE_Old #####
        elif (IDS_New != MTU_IDS):
